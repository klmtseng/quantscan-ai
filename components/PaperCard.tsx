...
const getSourceColor = (source: string) => {
  ...
  if (s.includes('nber')) return 'bg-rose-50 dark:bg-rose-900/20 text-rose-700 dark:text-rose-400 border border-rose-200 dark:border-rose-900/50';
  if (s.includes('world bank') || s.includes('imf')) return 'bg-cyan-50 dark:bg-cyan-900/20 text-cyan-700 dark:text-cyan-400 border border-cyan-200 dark:border-cyan-900/50';
  if (s.includes('bis') || s.includes('fed') || s.includes('bls')) return 'bg-emerald-50 dark:bg-emerald-900/20 text-emerald-700 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-900/50';
  if (s.includes('journal')) return 'bg-purple-50 dark:bg-purple-900/20 text-purple-700 dark:text-purple-400 border border-purple-200 dark:border-purple-900/50';
